...
class Seed_manual
{
    ...
    public static function seed_tbl_chart_account_type()
    {
        ...
        $insert[16]['chart_type_id']            = 16;
        $insert[16]['chart_type_name']          = "Contra-Purchase"; 
        $insert[16]['chart_type_description']   = '<p>Deduction that may be available to a seller if the buyer pays an invoice within a prescribed time, such as:<br /><br /></p></br>
                                                <p style="padding-left: 30px;">&bull; Purchase product</p></br>
                                                <p style="padding-left: 30px;"><span style="font-size: 12.96px;">&bull; Service </p></br>
                                                <p style="padding-left: 30px;"><span style="font-size: 12.96px;">&bull; Discount from vendors</p></br>
                                                <p style="padding-left: 30px;"><span style="font-size: 12.96px;">&nbsp;</p></br>
                                                <p style="padding-left: 30px;">&nbsp;</p>';
        $insert[16]['has_open_balance']         = "0"; 
        $insert[16]['chart_type_category']      = "";
        $insert[16]['normal_balance']           = "credit";

        $insert[17]['chart_type_id']            = 17;
        $insert[17]['chart_type_name']          = "Contra-Revenue"; 
        $insert[17]['chart_type_description']   = '<p>Shown as a deduction to Sales and may be available to a customer if the customer pays an invoice within a prescribed time, such as:<br /><br /></p></br>
                                                <p style="padding-left: 30px;">&bull; Purchase product</p></br>
                                                <p style="padding-left: 30px;"><span style="font-size: 12.96px;">&bull; Service </p></br>
                                                <p style="padding-left: 30px;"><span style="font-size: 12.96px;">&bull; Sales Discount</p></br>
                                                <p style="padding-left: 30px;"><span style="font-size: 12.96px;">&nbsp;</p></br>
                                                <p style="padding-left: 30px;">&nbsp;</p>';
        $insert[17]['has_open_balance']         = "0"; 
        $insert[17]['chart_type_category']      = "";
        $insert[17]['normal_balance']           = "debit";
    ...
    public static function seed_tbl_default_chart_account()
    {
       ...
       $insert[36]['default_id']                 = 36; 
       $insert[36]['default_type_id']            = "17";    
       $insert[36]['default_number']             = "70001";
       $insert[36]['default_name']               = "Sales Return & Allowances";
       $insert[36]['default_description']        = "Sales return occurs when there is actual return of a defective item. Sales allowance happens when the customer is willing to keep the item with a reduction in its selling price.";             
       $insert[36]['default_parent_id']          = "";              
       $insert[36]['default_sublevel']           = "";   
       $insert[36]['default_balance']            = "";
       $insert[36]['default_open_balance']       = "";
       $insert[36]['default_open_balance_date']  = "";
       $insert[36]['is_tax_account']             = "";
       $insert[36]['account_tax_code_id']        = "";
       $insert[36]['default_for_code']           = "sales-return-allowances";
    ...
    public static function seed_tbl_item_type()
    {
      ...
      $insert[5]['item_type_id']    = 6; 
      $insert[5]['item_type_name']  = "Other Charge";
