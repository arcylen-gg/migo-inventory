                                ...
                                <table class="table table-bordered table-striped table-condensed">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>            
                                            ...
                                            <td><input type="text" class="form-control text-center"  style="font-size: 14px" name="item_price[]" value="{{number_format($info['item_price'], 2)}}"></td>
                                            <td><input type="text" class="form-control text-center"  style="font-size: 14px" name="item_cost[]" value="{{number_format($info['item_cost'], 2)}}"></td>
