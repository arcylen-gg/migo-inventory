<div class="panel panel-default panel-block panel-title-block">
    <div class="panel-heading">
        ...
        <div>
            ...
            <div class="col-md-2"><input type="text" class="form-control from_report_a datepicker hidden" name="from" placeholder="Start Date"></div>
            <div class="col-md-2"><input type="text" class="form-control form_report_b datepicker hidden" name="to" placeholder="End Date"></div>
            <div class="col-md-3"><button class="btn btn-primary run-report hidden" onclick="$('.report_type_i').val('plain')" >Run Report</button></div>
