...
@section('content')
{!! $head !!}
@include('member.reports.filter.filterperyear')
@include('member.reports.dyandcy.monthly_report_output')
@endsection
...
<script type="text/javascript">
	...
	function event_run_report_click()
	{
		$(document).on("click", ".run-report", function()
		{
			...
			$(".load-data").load("/member/report/dyandcy/monthlyreport?"+serialize_data+"&load_view=true .load-content");
		});
	}
