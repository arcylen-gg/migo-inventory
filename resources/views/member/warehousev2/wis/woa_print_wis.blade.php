                    ...
                    <tfoot>
                        <tr>
                            <td colspan="7" style="text-align: right;">
                                <span style="font-size: 13px"><strong>TOTAL QUANTITY: </strong> {{$wis_item[0]->total_quantity}} PC</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: right;">
                                <span style="font-size: 13px"><strong>TOTAL: </strong> {{currency('PHP',$total)}}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
