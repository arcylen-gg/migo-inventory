...
<div class="panel panel-default panel-block panel-title-block">
    <div class="panel-heading">
        <div>
            ...
            <h1>
                <span class="page-title">Items &raquo; Inventory Adjustment</span>
                <small>
                </small>
            </h1>
            <a href="/member/item/import/inventory-adjustment-template" class="btn btn-custom-white pull-right">Download Item Template</a>
            <a href="/member/item/import/adjustment-export-error" class="btn btn-custom-white pull-right import-error hidden"></a>
        </div>
    </div>
</div>
...
var url_link = '/member/item/import/inventory-adjustment-read-file';
</script>
