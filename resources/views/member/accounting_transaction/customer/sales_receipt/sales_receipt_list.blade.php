...
<div class="panel panel-default panel-block panel-title-block panel-gray "  style="margin-bottom: -10px;">
    <ul class="nav nav-tabs">
        ...
        <li class="active change-tab cursor-pointer undelivered-tab" mode="undelivered"><a class="cursor-pointer"><i class="fa fa-folder-open-o"></i> Undelivered 
        </a></li>
        <li class="cursor-pointer change-tab delivered-tab" mode="delivered"><a class="cursor-pointer"><i class="fa fa-folder-o"></i> Delivered</a></li>
