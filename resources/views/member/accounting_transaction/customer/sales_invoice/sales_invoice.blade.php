            ...
            <div>
                ...
                <div class="dropdown pull-right">
                    ...
                    <div>
                        ...
                        <a class="btn btn-custom-white {{isset($accounting_module) ? ($accounting_module ? '' : 'hidden') : 'hidden'}}"  href="/member/accounting/journal/entry/invoice/{{$sales_invoice->inv_id}}">Transaction Journal</a>
                        @endif  
            ...
            <div class="tab-content">
                <div class="row">      
                    <div class="col-md-12" style="padding: 30px;">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-control input-sm new droplist-sales-rep" name="sales_rep_id">
                                    ...
                                    <option value="{{$salesrep->sales_rep_id}}" {{isset($sales_invoice->inv_sales_rep_id) ? ($sales_invoice->inv_sales_rep_id == $salesrep->sales_rep_id ? 'selected' : '') : ''}}>{{$salesrep->sales_rep_first_name . ' ' .$salesrep->sales_rep_middle_name.' '.$salesrep->sales_rep_last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @endif
                        ...
                        @include("member.accounting_transaction.customer.sales_invoice.sales_invoice_pm")
                                ...
                                <div class="col-sm-12">
                                    <table class="digima-table">
                                        ...
                                        <tbody class="draggable tbody-item estimate-tbl">
                                            @if(isset($sales_invoice))
                                                @foreach($sales_invoice_item as $key => $si_item)
                                                <tr class="tr-draggable">
                                                    ...
                                                    <td class="item-select-td">
                                                        <input class="form-control input-sm pull-left item-textbox hidden" value="{{$si_item->item_barcode}}" onkeypress="event_search($(this), event)" type="text"/>
                                                        <select class="1111 form-control select-item droplist-item input-sm pull-left item-select {{$si_item->invline_item_id}}" name="item_id[]" required >
                                                    ...
                                                    <td><input class="text-center number-input txt-qty change-qty compute" value="{{$si_item->invline_orig_qty}}" type="text" name="item_qty[]"/></td>
                                                    <td><input class="text-right number-input txt-rate compute" type="text" value="{{$si_item->invline_rate}}" name="item_rate[]"/></td>
                                                    <td><input class="text-right txt-discount compute" type="text" name="item_discount[]"  value="{{$si_item->invline_discount_type != 'fixed' ? ($si_item->invline_discount * 100).'%': $si_item->invline_discount}}"/></td>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="hidden"  name="item_taxable[]" class="taxable-input" value="{{$si_item->taxable}}">
                                                        <input type="checkbox" class="taxable-check compute" value="1" {{$si_item->taxable == 1 ? 'checked' : ''}}>
                                                    </td>
                                            ...
                                            <tr class="tr-draggable">
                                                ...
                                                <td><input class="text-right number-input txt-amount" type="text" name="item_amount[]"/></td>
                                                <td class="text-center">
                                                    <input type="hidden"  name="item_taxable[]" class="taxable-input change" value="">
                                                    <input type="checkbox" class="taxable-check compute" value="1" >
                                                </td>
                                                <td class="text-center remove-tr cursor-pointer">
                                                    <i class="fa fa-trash-o" aria-hidden="true"></i>
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <div class="col-md-7 text-right digima-table-label">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2  padding-lr-1">
                                                <input class="form-control input-sm text-right number-input discount_txt compute" type="text" name="customer_discount" value="{{$sales_invoice->inv_discount_value or ''}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5 text-right digima-table-value">
                                ...
                                @if(isset($sales_invoice))
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 text-right digima-table-value">
                                            <input type="text" name="payment-receive" class="hidden payment-receive-input" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 text-right digima-table-value total">
                                            <input type="text" name="balance-due" class="hidden balance-due-input" value="{{ $sales_invoice->inv_payment_applied }}" />
                                            PHP&nbsp;<span class="balance-due">{{currency('',($sales_invoice->inv_overall_price - $sales_invoice->inv_payment_applied))}}</span>
                                        </div>
                                    </div>
                                @endif
                            </div>
