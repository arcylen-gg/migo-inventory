    ...
    <div class="panel-heading">
        <div>
            ...
            <div class="dropdown pull-right">
                <button onclick="location.href='/member/transaction/delivery_report/create'" class="btn btn-primary"><i class="fa fa-star"></i> Delivery Report</button>
            </div>
        </div>
    </div>
</div>
...
@endsection
@section('script')
<script type="text/javascript" src="/assets/member/js/accounting_transaction/customer/dr_list.js"></script>
@endsection