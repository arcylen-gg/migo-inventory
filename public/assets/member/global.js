        ...
        $.ajax({
            ...
            error: function(x,t,m)
            {
                ...
                if(t==="timeout") {
                    ...
                    $(".modal-loader").addClass("hidden");
                    toastr.warning(m + '. Please Contact The Administrator.');
                }
...
function action_load_main_modal(url, size)
{
    ...
    if($.isNumeric(size))
    {
        $("#global_modal").find(".modal-dialog").attr("style", "width:"+size+"px;");
    }
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.response == "success")
            {
                ...
                $('.warehouse-access-name').load("/member/load_warehouse_name" +  ' .warehouse-access-name');
