...
var load_table_data = {};
load_table_data.status = 'pending';
...
function customer_wis()
{
    ...
    function action_click_tab()
    {
        $("body").on("click", ".change-tab", function(e)
        {
            ...
            load_table_data.status = $(e.currentTarget).attr("mode");
    ...
    function action_load_table()
    {
        ...
        $.ajax(
        {
            url:"/member/transaction/wis/customer-load-wis-table",
...
{
    // $('.customer-wis-container').load('/member/transaction/wis/customer-load-wis-table?status='+status+' .customer-wis-table');
}
