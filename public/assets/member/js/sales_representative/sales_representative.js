var sales_representative = new sales_representative();
var load_table_data = {};
load_table_data.tab_type = 'open';

function sales_representative()
{
	init();
	...
	function action_load_table()
	{
		...
		$.ajax(
		{
			url:"/member/utilities/sales-representative-table",
...
function success_added_sales_rep(data) 
{
	if(data.status == 'success')
	{
        toastr.success(data.status_message);
		data.element.modal("toggle");
		sales_representative.action_load_table();
	}
}