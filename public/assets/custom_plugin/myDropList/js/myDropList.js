      ...
      if($select.data("options-settings")) {
        ...
        recursion_list: function(list_ul)
        {
          ...
          $select.find("option").each( function(indx)
          {
            ...
            var sku       = $(this).attr("item-sku");
            var barcode   = $(this).attr("item-barcode");
            var txt       = $(this).text();
        ...
        search: function(value)
        {
          ...
          options.each(function() 
          {
            ...
            var sku = $.trim(($(this).attr("item-sku")+"").toLowerCase());
            var barcode = $.trim(($(this).attr("item-barcode")+"").toLowerCase());
            console.log($(this));
            console.log(barcode);
            if(value == text)
            {
            ...
            else if(barcode.indexOf(value) >= 0) 
            {
              add = true;
            }
